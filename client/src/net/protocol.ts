...
export type EntityState = 'IDLE' | 'MOVING' | 'ATTACKING' | 'COOLDOWN' | 'DEAD';
export interface Vector2D { x: number; y: number; }

// ============================================
// ENUMS DE TIPO DE MENSAGEM (Refactored to Const Objects)
// ============================================

/**
 * Tipos de mensagem Client → Server
 */
export const C2SMessageType = {
...
export type C2SMessageType = typeof C2SMessageType[keyof typeof C2SMessageType];

/**
 * Tipos de mensagem Server → Client
 */
export const S2CMessageType = {
...
export type S2CMessageType = typeof S2CMessageType[keyof typeof S2CMessageType];
...
export type EntityStateCode = typeof EntityStateCode[keyof typeof EntityStateCode];
...
export interface C2SQueueJoin extends C2SMessageBase {
    type: typeof C2SMessageType.QUEUE_JOIN;
...
export interface C2SQueueLeave extends C2SMessageBase {
    type: typeof C2SMessageType.QUEUE_LEAVE;
}
...
export interface C2SSpawnCard extends C2SMessageBase {
    type: typeof C2SMessageType.SPAWN_CARD;
...
export interface C2SLogin extends C2SMessageBase {
    type: typeof C2SMessageType.LOGIN;
    playerId: string;
}
...
export interface S2CQueueJoined extends S2CMessageBase {
    type: typeof S2CMessageType.QUEUE_JOINED;
...
export interface S2CMatchStart extends S2CMessageBase {
    type: typeof S2CMessageType.MATCH_START;
    /** ID único da sala */
    roomId: string;
...
export interface S2CEntitySpawned extends S2CMessageBase {
    type: typeof S2CMessageType.ENTITY_SPAWNED;
...
export interface S2CGameTick extends S2CMessageBase {
    type: typeof S2CMessageType.GAME_TICK;
...
export interface S2CMatchEnd extends S2CMessageBase {
    type: typeof S2CMessageType.MATCH_END;
...
export interface S2CError extends S2CMessageBase {
    type: typeof S2CMessageType.ERROR;
    /** Código do erro */
    code: string;
    /** Mensagem legível */
    message: string;
...
export interface S2CLoginSuccess extends S2CMessageBase {
    type: typeof S2CMessageType.LOGIN_SUCCESS;
    player: {
        id: string;
        name: string;
        inventory: string[];
