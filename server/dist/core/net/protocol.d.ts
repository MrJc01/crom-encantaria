 ...
 */
export declare enum C2SMessageType {
 ...
 */
export declare enum S2CMessageType {
 ...
 */
export declare enum EntityStateCode {
    IDLE = 0,
    MOVING = 1,
    ATTACKING = 2,
    COOLDOWN = 3,
 ...
 */
export declare function stateToCode(state: EntityState): EntityStateCode;
/**
 * Mensagem base C2S.
 */
 ...
 */
export type S2CMessage = S2CQueueJoined | S2CMatchStart | S2CEntitySpawned | S2CGameTick | S2CMatchEnd | S2CError;
/**
 * Serializa uma mensagem S2C para JSON string.
 */
export declare function serializeMessage(message: S2CMessage): string;
/**
 * Parseia uma mensagem C2S do cliente.
 * @throws Error se o JSON for inválido ou o tipo for desconhecido
 */
export declare function parseC2SMessage(data: string): C2SMessage;
/**
 * Cria uma mensagem de erro.
 */
export declare function createErrorMessage(code: string, message: string): S2CError;
